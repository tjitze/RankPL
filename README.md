...
Semantically, RankPL is based on *ranking theory*, a formalism for reasoning about uncertainty in which events receive integer-valued ranks that represent degrees of surprise. Ranks are a *semi-qualitative* abstracton of probabilities, in the sense that they are numeric, but based on discrete values rather than real-valued probabilities. Still, many powerful features of probability theory carry over to ranking theory. This includes a ranking-theoretic equivalent of Bayesian conditioning and the ability to represent complex (in)dependence relationships. Ranking theory originates from the field of formal epistemology and has been applied in logic-based AI approaches such as belief revision and non-monotonic reasoning.
