...
public class NotEquals extends Expression {
	...
	public LanguageElement replaceVariable(String a, String b) {
		return new NotEquals((Expression)e1.replaceVariable(a, b), (Expression)e2.replaceVariable(a, b));
	}
	...
	public Expression transformRankExpressions(VarStore v, int rank) throws RPLException {
		return new NotEquals((Expression)e1.transformRankExpressions(v, rank), (Expression)e2.transformRankExpressions(v, rank));
	}
	...
	public Expression replaceEmbeddedFunctionCall(AbstractFunctionCall fc, String var) {
		return new NotEquals((Expression)e1.replaceEmbeddedFunctionCall(fc, var), (Expression)e2.replaceEmbeddedFunctionCall(fc, var));
	}
