...
public class MapGet extends AbstractExpression {
	...
	public AbstractExpression transformRankExpressions(VarStore v, int rank) throws RPLException {
		AbstractExpression e = new MapGet(map.transformRankExpressions(v, rank), key.transformRankExpressions(v, rank));
	...
	public AbstractExpression replaceEmbeddedFunctionCall(AbstractFunctionCall fc, String var) {
		AbstractExpression e = new MapGet((AbstractExpression) map.replaceEmbeddedFunctionCall(fc, var),
	...
	public String toString() {
		return "get(" + StringTools.stripPars(map.toString()) + ", " + StringTools.stripPars(key.toString()) + ")";
	}

	public boolean equals(Object o) {
		return (o instanceof MapGet) && ((MapGet) o).map.equals(map) && ((MapGet) o).key.equals(key);
	}
