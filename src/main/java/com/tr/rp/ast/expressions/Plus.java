...
/**
 * The plus (+) expression. Works on integers as usual, and on strings as a
 * concatenation operator. Also allows concatenation of strings with other
 * types.
 */
public class Plus extends AbstractExpression {
	...
	public AbstractExpression transformRankExpressions(VarStore v, int rank) throws RPLException {
		AbstractExpression e = new Plus((AbstractExpression) e1.transformRankExpressions(v, rank),
	...
	public AbstractExpression replaceEmbeddedFunctionCall(AbstractFunctionCall fc, String var) {
		AbstractExpression e = new Plus((AbstractExpression) e1.replaceEmbeddedFunctionCall(fc, var),
	...
	public boolean equals(Object o) {
		return (o instanceof Plus) && ((Plus) o).e1.equals(e1) && ((Plus) o).e2.equals(e2);
	}
