...
public class JShifterTest extends RPLBaseTest {
	...
	public static VarStore s7 = new PMapVarStore().create("x", 7);
	public static VarStore s8 = new PMapVarStore().create("x", 8);
	public static VarStore s9 = new PMapVarStore().create("x", 9);
