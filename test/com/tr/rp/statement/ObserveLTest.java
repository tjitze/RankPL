...
public class ObserveLTest extends RPLBaseTest {
	...
	public void testObserveShenoy() {
		...
		ObserveL o = new ObserveL(new Equals("a", 3), 0);
		...
		o = new ObserveL(new Equals("a", 3), 1);
		...
		o = new ObserveL(new Equals("a", 3), 2);
		result = o.getIterator(this.getTestIterator());
		...
		o = new ObserveL(new Equals("a", 3), 3);
		result = o.getIterator(this.getTestIterator());
		...
		o = new ObserveL(new Equals("a", 3), 4);
		result = o.getIterator(this.getTestIterator());
